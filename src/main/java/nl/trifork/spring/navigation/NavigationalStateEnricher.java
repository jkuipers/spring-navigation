...
public interface NavigationalStateEnricher<T> {
     ...
     *         {@code T}
     */
    T updateOnBasePageVisit(Object attribute);
     ...
     *         {@code T}
     */
    T updateOnStepPageVisit(Object attribute);

    /**
     * This method is called by {@link NavigationHandlerInterceptor} when visiting a controller, but after
     * {@link #updateOnBasePageVisit(Object)} or {@link #updateOnStepPageVisit(Object)}.
     *
